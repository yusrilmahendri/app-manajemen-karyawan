<a href="{{ route('owner.user.show', $model) }}" 
...
<a href="{{ route('owner.user.edit', $model ) }}" class="btn btn-info">
  <div class="icon">
...
<button href="{{ route('owner.user.destroy', $model )}}" class="btn btn-danger" 
