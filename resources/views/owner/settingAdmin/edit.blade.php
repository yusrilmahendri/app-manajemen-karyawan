        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
                <li class="nav-item">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Ubah Data Pengguna</button>
                </li>
            </ul>
            ...
            <div class="tab-content pt-2">
                ...
                <!-- Profile Edit Form -->
                <form action="{{ route('owner.admin.update', $user) }}" method="POST">

                  {{csrf_field()}}
                  @method("PUT")
                  
                  <div class="row mb-3 @error('name') has-error @enderror">
                    <label for="Job" class="col-md-4 col-lg-3 col-form-label">Name Pengguna</label>
